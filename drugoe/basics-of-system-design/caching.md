...
### Application server cache <a href="#application-server-cache" id="application-server-cache"></a>
...
### Content Delivery (or Distribution) Network (CDN) <a href="#content-delivery-or-distribution-network-cdn" id="content-delivery-or-distribution-network-cdn"></a>
...
### Cache eviction policies <a href="#cache-eviction-policies" id="cache-eviction-policies"></a>
