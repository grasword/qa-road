...
### High level differences between SQL and NoSQL <a href="#high-level-differences-between-sql-and-nosql" id="high-level-differences-between-sql-and-nosql"></a>
...
### SQL VS. NoSQL - Which one to use? <a href="#sql-vs.-nosql-which-one-to-use" id="sql-vs.-nosql-which-one-to-use"></a>
...
### Reasons to use SQL database <a href="#reasons-to-use-sql-database" id="reasons-to-use-sql-database"></a>
...
### Reasons to use NoSQL database <a href="#reasons-to-use-nosql-database" id="reasons-to-use-nosql-database"></a>
